...
.. image:: https://img.shields.io/badge/cache-optimization-brightblue.svg
    :target: https://github.com/rasty94/kolla/blob/master/docs/source/build-cache.md
    :alt: Build Cache Optimization

.. image:: https://img.shields.io/badge/security-scanning-important.svg
    :target: https://github.com/rasty94/kolla/blob/master/docs/source/security-scanning.md
    :alt: Container Security Scanning

.. image:: https://img.shields.io/badge/buildkit-enabled-success.svg
    :alt: BuildKit Support
